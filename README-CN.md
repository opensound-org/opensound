...
我们另有两个[自动推送](.github/workflows/mirror.yml)的下游只读镜像：[GitLab](https://gitlab.com/opensound-org/opensound)和[Gitee](https://gitee.com/opensound-org/opensound)。由于它们是只读镜像，因此请不要在这两个平台上发起任何合并请求或pull request。
